          ...
          <div className="h-full flex flex-col lg:flex-row justify-between items-center">
            ...
            <div className="h-full xl:w-[50%] lg:w-[60%] sm:w-[70%] w-full text-white flex flex-col gap-4 justify-center">
              ...
              <p className="text-lg font-mono lg:my-8 my-4 leading-relaxed text-gray-200">
                A passionate Python/Django developer with 1.5+ years of
                experience. I specialize in building high-performance web
                applications with expertise in Django, PostgreSQL, TailwindCSS,
                React, and more. Let&apos;s build something amazing together!
              </p>

              <div className="flex flex-col sm:flex-row gap-4 lg:mt-6 mt-4">
                <Link
                  href="/"
                  className="w-full sm:w-auto md:px-8 px-6 md:py-4 py-3 md:text-xl text-lg font-semibold rounded-lg bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-blue-500 hover:to-cyan-400 text-white shadow-lg transition-all duration-300"
                >
                  Hire Me
                </Link>
                <Link
                  href="/about"
                  className="w-full sm:w-auto md:px-8 px-6 md:py-4 py-3 md:text-xl text-lg font-semibold rounded-lg border-2 border-gray-200 text-white hover:bg-gray-100 hover:text-black shadow-lg transition-all duration-300"
                >
                  About Me
                </Link>
              </div>
